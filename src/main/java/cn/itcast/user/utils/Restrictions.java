...
import com.scistor.utils.Criterion.MatchMode;
import com.scistor.utils.Criterion.Operator;
...
public class Restrictions {
    ...
    public static SimpleExpression regexp(String fieldName,Object value) {
    	if(value.equals(null))return null;  
        return new SimpleExpression (fieldName, value, Operator.REG);
    }
