...
public class SmsUtils {
    ...
    // 需开发者指定
    private static String accessKeyId = "LTAI4GBCoV61C1bbtH5cZnVe";

    // 需开发者指定
    private static String accessKeySecret = "cMIp8JSA8rEZyjUJhk5dgMGS7WWhK7";
    ...
    public static void main(String[] args) throws Exception {
        SendSmsResponse sendSmsResponse = sendSms("18841467747", "黑马旅游网", "SMS_205474595", "{\"code\":\"123456\"}");
